// The event's guest/table data now lives in IndexedDB (see lib/db.ts) so the app can hold many
// events at once. localStorage is kept only for small, app-level UI preferences below.
